...
const timings = ['4:00 PM', '4:30 PM', '5:00 PM', '5:30 PM'];
const weekdays = [
  'Sunday',
  'Monday',
  'Tuesday',
...
const Docbook = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-sky-500 via-blue-500 p-0.5 to-indigo-500 rounded-xl flex items-center justify-center flex-col">
      <div className="h-full w-full bg-slate-900 p-4 rounded-xl flex flex-col gap-4">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4">
            {timings.map((time, index) => (
              <div
                ...
                className={
                  selectedTime === time
                    ? 'bg-indigo-500 rounded-md cursor-pointer px-2 py-1'
          ...
          <button className="w-full bg-indigo-400 rounded-md py-1 text-indigo-900">
            Book Appointment
          </button>
        </div>
        <div className="p-2 bg-indigo-950 rounded-md flex flex-col gap-4">
